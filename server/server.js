...
app.get(`http://${BACKEND_URL}/api/divisions/:id/members`, async (req, res) => {
  try {
...
// PATCH division
app.patch(`http://${BACKEND_URL}/api/divisions/:id`, async (req, res) => {
  try {
    const { id } = req.params;
...
// GET division by ID
app.get(`http://${BACKEND_URL}/api/divisions/:id`, async (req, res) => {
  try {
    const { id } = req.params;
...
app.get(`http://${BACKEND_URL}/api/employees/similaremployees`, async (req, res) => {
  try {
...
// GET candidates
app.get(`http://${BACKEND_URL}/api/employees/candidates`, async (req, res) => {
  try {
...
// GET divisions
app.get(`http://${BACKEND_URL}/api/divisions`, async (req, res) => {
  try {
...
// POST new division
app.post(`http://${BACKEND_URL}/api/divisions`, async (req, res) => {
  try {
    const { name, boss, budget, country, city } = req.body;
...
app.get(`http://${BACKEND_URL}/employee/:id/address`, async (req, res) => {
  try {
    const { id } = req.params;
...
app.patch(`http://${BACKEND_URL}/employee/:id/address`, async (req, res) => {
  try {
    const { id } = req.params;
...
//GET Tools by ID
app.get(`http://${BACKEND_URL}/tools/:id`, async (req, res) => {
  try {
    const { id } = req.params;
...
app.get(`http://${BACKEND_URL}/games-list/:id`, async (req, res) => {
  try {
    const { id } = req.params;
...
// POST new board game
app.post(`http://${BACKEND_URL}/games`, async (req, res) => {
  try {
...
// GET Board games
app.get(`http://${BACKEND_URL}/games-list`, async (req, res) => {
  try {
...
// POST new kitten
app.post(`http://${BACKEND_URL}/api/kittens/:employeeId`, async (req, res) => {
  try {
...
// Display kittens
app.get(`http://${BACKEND_URL}/api/kittens/:employeeId`, async (req, res) => {
  try {
    const { employeeId } = req.params;
...
// POST new tool
app.post(`http://${BACKEND_URL}/tools`, async (req, res) => {
  try {
    const { name, weight } = req.body;
...
// Display tools
app.get(`http://${BACKEND_URL}/tools`, async (req, res) => {
  try {
    const { filter } = req.query;
    let tools;
...
// Display top-paid
app.get(`http://${BACKEND_URL}/top-paid`, async (req, res) => {
  try {
...
// Display superheroes
app.get(`http://${BACKEND_URL}/employees/superheroes`, async (req, res) => {
  try {
...
// GET all brands
app.get(`http://${BACKEND_URL}/brands`, async (req, res) => {
  try {
...
// PATCH brand by ID
app.patch(`http://${BACKEND_URL}/brands/:id`, async (req, res) => {
  try {
...
// GET all equipment
app.get(`http://${BACKEND_URL}/equipment`, async (req, res) => {
  try {
...
app.delete(`http://${BACKEND_URL}/equipment/:id`, async (req, res) => {
  try {
...
// POST new equipment
app.post(`http://${BACKEND_URL}/equipment`, async (req, res) => {
  try {
...
app.patch(`http://${BACKEND_URL}/equipment/:id`, async (req, res) => {
  try {
...
app.get(`http://${BACKEND_URL}/api/employees/missing`, async (req, res) => {
  try {
...
app.get(`http://${BACKEND_URL}/employees/:search`, async (req, res) => {
...
// Sorting, filtering
app.get(`http://${BACKEND_URL}/api/employees/sorted`, async (req, res) => {
  try {
...
// Display employees
app.get(`http://${BACKEND_URL}/api/employees/`, async (req, res) => {
...
app.get(`http://${BACKEND_URL}/api/employees/:id`, async (req, res) => {
...
app.post(`http://${BACKEND_URL}/api/employees/`, async (req, res, next) => {
...
app.patch(`http://${BACKEND_URL}/api/employees/:id/missing`, async (req, res) => {
  try {
...
app.patch(`http://${BACKEND_URL}/api/employees/:id`, async (req, res, next) => {
  try {
    const employee = await EmployeeModel.findOneAndUpdate(
      { _id: req.params.id },
      { $set: { ...req.body } },
...
app.delete(`http://${BACKEND_URL}/api/employees/:id`, async (req, res, next) => {
  try {
