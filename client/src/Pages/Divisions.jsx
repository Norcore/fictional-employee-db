...
const Divisions = () => {
    ...
    useEffect(() => {
        fetch(`http://${process.env.REACT_APP_BACKEND_URL}:3001/api/divisions`)
    ...
    return (
        <div>
                    ...
                    {availableDivisions.map(division => {
                        return (
                            ...
                            <tr key={division._id}>
                                ...
                                <td>
                                    <Link to={`http://${process.env.REACT_APP_FRONTEND_URL}/divisions/${division._id}`}>
                                ...
                                <td>
                                <Link to={`http://${process.env.REACT_APP_FRONTEND_URL}/divisions/${division._id}/details`}>
            ...
            <Link to={`http://${process.env.REACT_APP_BACKEND_URL}:3001/divisions/create`}>
