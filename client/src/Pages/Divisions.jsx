...
const Divisions = () => {
    ...
    return (
        <div>
                    ...
                    {availableDivisions.map(division => {
                        return (
                            ...
                            <tr key={division._id}>
                                ...
                                <td>
                                    <Link to={`http://localhost:8080/divisions/${division._id}`}>
                                ...
                                <td>
                                <Link to={`http://localhost:8080/divisions/${division._id}/details`}>
            ...
            <Link to={'http://localhost:8080/divisions/create'}>
