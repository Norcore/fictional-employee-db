...
const DivisionForm = () => {
    ...
    useEffect(() => {
        fetch(`${process.env.REACT_APP_BACKEND_URL}:3001/api/divisions/${id}`)
    ...
    useEffect(() => {
        fetch(`${process.env.REACT_APP_BACKEND_URL}:3001/api/employees/candidates`)
            .then(response => response.json())
    ...
    const divisionUpdate = async (e) => {
        ...
        try {
            await fetch(`${process.env.REACT_APP_BACKEND_URL}:3001/api/divisions/${id}`, {
                method: 'PATCH',
                headers: {
                ...
                navigate(`${process.env.REACT_APP_BACKEND_URL}:3001/divisions`);
            // }
        } catch (error) {
