...
const DivisionForm = () => {
    ...
    useEffect(() => {
        fetch(`${process.env.REACT_APP_BACKEND_URL}/api/divisions/${id}`)
    ...
    useEffect(() => {
        fetch(`${process.env.REACT_APP_BACKEND_URL}/api/employees/candidates`)
            .then(response => response.json())
    ...
    const divisionUpdate = async (e) => {
        ...
        try {
            await fetch(`${process.env.REACT_APP_BACKEND_URL}/api/divisions/${id}`, {
                method: 'PATCH',
                headers: {
                ...
                navigate(`${process.env.REACT_APP_BACKEND_URL}/divisions`);
            // }
        } catch (error) {
